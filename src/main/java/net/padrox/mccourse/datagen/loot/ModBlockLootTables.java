package net.padrox.mccourse.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(ModBlocks.RAW_ALEXANDRITE_PRESSURE_PLATE.get());
        this.dropSelf(ModBlocks.RAW_ALEXANDRITE_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.RAW_ALEXANDRITE_TRAPDOOR.get());
        this.dropSelf(ModBlocks.ALEXANDRITE_TRAPDOOR.get());

        this.add(ModBlocks.RAW_ALEXANDRITE_DOOR.get(),
                block -> createDoorTable(ModBlocks.RAW_ALEXANDRITE_DOOR.get()));
