...
public class ModItems {
    ...
    public static final RegistryObject<Item> ALEXANDRITE_GEM = ITEMS.register("alexandrite_gem",
            () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PURIFIED_ALEXANDRITE_GEM = ITEMS.register("purified_alexandrite_gem",
            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> HEAVENS_BLADE = ITEMS.register("heavens_blade",
            () -> new HeavensBladeItem(ModToolTiers.ALEXANDRITE, 3, 3, new Item.Properties().durability(256)));

    public static final RegistryObject<Item> ALEXANDRITE_PICKAXE = ITEMS.register("alexandrite_pickaxe",
            () -> new PickaxeItem(ModToolTiers.ALEXANDRITE, 1, 2, new Item.Properties().durability(256)));
    public static final RegistryObject<Item> ALEXANDRITE_AXE = ITEMS.register("alexandrite_axe",
            () -> new AxeItem(ModToolTiers.ALEXANDRITE, 2, 1, new Item.Properties().durability(256)));
    public static final RegistryObject<Item> ALEXANDRITE_SHOVEL = ITEMS.register("alexandrite_shovel",
            () -> new ShovelItem(ModToolTiers.ALEXANDRITE, 1, 2, new Item.Properties().durability(256)));
    public static final RegistryObject<Item> ALEXANDRITE_HOE = ITEMS.register("alexandrite_hoe",
            () -> new HoeItem(ModToolTiers.ALEXANDRITE, 1, 2, new Item.Properties().durability(256)));
    public static final RegistryObject<Item> ALEXANDRITE_PAXEL = ITEMS.register("alexandrite_paxel",
            () -> new PaxelItem(ModToolTiers.ALEXANDRITE, 1, 2, new Item.Properties().durability(256)));
    public static final RegistryObject<Item> ALEXANDRITE_HAMMER = ITEMS.register("alexandrite_hammer",
            () -> new HammerItem(ModToolTiers.ALEXANDRITE, 1, 2, new Item.Properties().durability(256)));
    ...
    public static final RegistryObject<Item> ALEXANDRITE_LEGGINS = ITEMS.register("alexandrite_leggings",
